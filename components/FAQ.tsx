...
const faqs = [
  ...
  },
  {
    ...
    a: "เวลาเช็คอินปกติคือ 14:00 น. หากต้องการเช็คอินก่อน กรุณาแจ้งล่วงหน้าครับ ทางโรงแรมจะพยายามจัดห้องให้ตามความพร้อม ขึ้นอยู่กับห้องว่างในวันนั้น และมีค่าบริการเพิ่มเติมครับ",
  },
  {
  ...
  },
  {
    ...
    a: "โรงแรมตั้งอยู่ใจกลางเมืองตาก ใกล้ศาลพระเจ้าตากสิน (800 เมตร) สะพานแขวนริมแม่น้ำปิงและถนนคนเดินริมปิง (ราว 950 เมตร) และสวนสาธารณะ สะดวกสำหรับการเดินทางท่องเที่ยวมากครับ",
  },
  {
    q: "ห้องพักราคาเท่าไหร่? มีห้องราคาถูกไหม?",
    a: "ราคาห้องเริ่มต้นที่ 690 บาท/คืน (Deluxe King) ไปจนถึง 1,190 บาท/คืน (Family Room) ทุกราคารวมอาหารเช้าแล้ว เป็นที่พักในเมืองตากที่คุ้มค่า จองตรงกับโรงแรมได้ราคาดีที่สุด ไม่ผ่านตัวแทนครับ",
  },
  {
    q: "มีห้องพักได้ 3-4 คน หรือห้องสำหรับครอบครัวไหม?",
    a: "มีครับ ห้อง Family Room รองรับได้ 3 ท่าน มีเตียงใหญ่ 6 ฟุต เตียงเด็ก 3 ฟุต และกระโจมสำหรับเด็ก ราคา 1,190 บาท/คืน รวมอาหารเช้า 3 ท่าน ทุกห้องยังเสริมเตียงเพิ่มได้อีก 1 เตียงครับ",
  },
  {
    q: "เหมาะกับแวะพักระหว่างเดินทางเชียงใหม่-กรุงเทพไหม?",
    a: "เหมาะมากครับ โรงแรมอยู่ใจกลางเมืองตาก หาง่ายจากถนนหลัก มีที่จอดรถฟรี เช็คอิน 14:00 น. รวมอาหารเช้า เป็นจุดพักกลางทางที่สะดวกสำหรับผู้เดินทางระหว่างภาคเหนือและกรุงเทพฯ",
  },
  {
