        ...
        <ScrollReveal>
          <div className="text-center mb-14">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              {/* Google */}
              <div className="inline-flex items-center gap-4 bg-cream border border-gray-200 px-6 py-4 shadow-luxury">
                <div className="text-center">
                  <p className="font-montserrat text-4xl font-bold text-gray-900 leading-none">4.4</p>
                  <StarRating count={4} />
                ...
                <div className="text-left">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-montserrat text-sm font-semibold text-gray-700">Google</span>
                  </div>
                  <p className="font-sarabun text-xs text-gray-500">รีวิวจากผู้เข้าพักจริง</p>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-4 bg-cream border border-gray-200 px-6 py-4 shadow-luxury">
                <div className="text-center">
                  <p className="font-montserrat text-4xl font-bold text-gray-900 leading-none">8.6</p>
                  <p className="font-sarabun text-[10px] text-emerald-600 font-semibold mt-1">Excellent</p>
                  <p className="font-sarabun text-xs text-gray-400">1,335 รีวิว</p>
                </div>
                <div className="w-px h-12 bg-gray-200" />
                <div className="text-left">
                  <div className="flex items-center gap-2 mb-1">
                    <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none">
                      ...
                      <text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="18" fontWeight="bold" fontFamily="Arial">a</text>
                    </svg>
                    <span className="font-montserrat text-sm font-semibold text-gray-700">Agoda</span>
                  </div>
                  <div className="space-y-0.5">
                    <p className="font-sarabun text-[10px] text-gray-400">ความสะอาด <span className="text-gray-600 font-semibold">8.9</span> · บริการ <span className="text-gray-600 font-semibold">8.9</span></p>
                    <p className="font-sarabun text-[10px] text-gray-400">ทำเล <span className="text-gray-600 font-semibold">8.8</span> · คุ้มราคา <span className="text-gray-600 font-semibold">8.8</span></p>
                  </div>
                </div>
              </div>
              ...
              <div className="inline-flex items-center gap-4 bg-cream border border-gray-200 px-6 py-4 shadow-luxury">
                <div className="text-center">
                  <p className="font-montserrat text-4xl font-bold text-gray-900 leading-none">8.4</p>
                  <p className="font-sarabun text-[10px] text-blue-600 font-semibold mt-1">Excellent</p>
                  <p className="font-sarabun text-xs text-gray-400">108 รีวิว</p>
                </div>
                <div className="w-px h-12 bg-gray-200" />
                <div className="text-left">
                  <div className="flex items-center gap-2 mb-1">
                    <svg className="w-5 h-5" viewBox="0 0 40 40" fill="none">
                      <rect width="40" height="40" rx="4" fill="#003580"/>
                      <text x="50%" y="55%" dominantBaseline="middle" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial">B.</text>
                    </svg>
                    <span className="font-montserrat text-sm font-semibold text-gray-700">Booking.com</span>
                  </div>
                  <div className="space-y-0.5">
                    <p className="font-sarabun text-[10px] text-gray-400">ความสะอาด <span className="text-gray-600 font-semibold">8.5</span> · บริการ <span className="text-gray-600 font-semibold">8.7</span></p>
                    <p className="font-sarabun text-[10px] text-gray-400">ทำเล <span className="text-gray-600 font-semibold">8.3</span> · คุ้มราคา <span className="text-gray-600 font-semibold">8.4</span></p>
                  </div>
                </div>
              </div>
